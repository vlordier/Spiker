...
class MultiCycle(VHDLblock):
    ...
    def vhdl(self, debug=False, debug_list=None):
        ...
        self.entity.port.add(name="all_ready", direction="in", port_type="std_logic")

        # Output
        self.entity.port.add(name="ready", direction="out", port_type="std_logic")

        self.entity.port.add(name="restart", direction="out", port_type="std_logic")

        self.entity.port.add(name="start_all", direction="out", port_type="std_logic")

        # Signals
        self.architecture.signal.add(name="cycles_cnt_en", signal_type="std_logic")
        self.architecture.signal.add(name="cycles_cnt_rst_n", signal_type="std_logic")
        self.architecture.signal.add(name="stop", signal_type="std_logic")
