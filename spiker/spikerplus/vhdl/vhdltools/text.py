...
VhdlClass = TypeVar("Whichever classimlementing the code() method")
...
class GenericCodeBlock(dict):
    r"""Generate a block of text. The block is treated as a dictionary with
    integer keys.
    ...
    def add(self, text: str | VhdlClass, line_end: str = "\n"):
        """Add a single line of text to the block.
